    ...
    var g = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        b = function (e, o) {
            ...
            this.getOffset = function () {
                            ...
                            v.scrollmom = new x(v), v.ontouchstart = function (e) {
                                ...
                                if (!v.locked) {
                                    ...
                                    if (v.rail.drag = {
                                        ...
                                        v.rail.drag.ck = !v.rail.scrollable && v.railh.scrollable ? l > 0 ? "v" : !1 : v.rail.scrollable && !v.railh.scrollable && a > 0 ? "h" : !1, v.rail.drag.ck || (v.rail.drag.dl = "f")
                                    }
                ...
                return v.cursorfreezed = !1, py = v.getScrollTop(!0), 0 > t && py <= 0 ? v.noticeCursor() : t > v.page.maxh && py >= v.page.maxh ? (v.checkContentSize(), v.noticeCursor()) : void v.doScrollTop(t)
                ...
                return v.cursorfreezed = !1, px = v.getScrollLeft(!0), 0 > t && px <= 0 ? v.noticeCursor() : t > v.page.maxw && px >= v.page.maxw ? v.noticeCursor() : void v.doScrollLeft(t)
...
if (typeof google !== 'undefined') {
    !function () {
        ...
        function i(t, e) {
            if (t.c) {
                var o = "";
                -1 !== navigator.userAgent.indexOf("Gecko/") ? ("dragging" == e && (o = "-moz-grabbing"), "dragready" == e && (o = "-moz-grab")) : ("dragging" == e || "dragready" == e) && (o = "move"), "draggable" == e && (o = "pointer"), t.a.style.cursor != o && (t.a.style.cursor = o)
            }
        }
        ...
        function r(t) {
            t.getDraggable() && t.d && (t.d = c, t.getMap().set("draggable", t.m), t.h = t.i = t.m = null, t.a.style.MozUserSelect = "", t.a.style.KhtmlUserSelect = "", t.a.style.WebkitUserSelect = "", t.a.unselectable = "off", t.a.onselectstart = function () {
            }, h(t), i(t, "draggable"), google.maps.event.trigger(t, "dragend"), t.draw())
        }
            ...
            var o = {
                    ...
                    , construct: function () {
                        ...
                        e(".minicolors").minicolors({
                                theme: "bootstrap", change: function (e) {
                                    console.log("E in construct", e);
                                    o.configColor(e)
                                }
                            }
                        )
                    ...
                    , convertHex: function (e, o) {
                        e = e.replace("#", "");
                        var t = parseInt(e.substring(0, 2), 16), r = parseInt(e.substring(2, 4), 16),
                            n = parseInt(e.substring(4, 6), 16), l = "rgba(" + t + "," + r + "," + n + "," + o / 100 + ")";
                        console.log("convertHEx     o: " + e + "    ,num: " + o, l);
                        return l
                    }
                    , colorLuminance: function (e, o) {
                        ...
                        for (r = 0;
                             3 > r;
                             r++) t = parseInt(e.substr(2 * r, 2), 16), t = Math.round(Math.min(Math.max(0, t + t * o), 255)).toString(16), n += ("00" + t).substr(t.length);
                        console.log("Color luminance", n);
                        return n
                    }
                }
            ;
