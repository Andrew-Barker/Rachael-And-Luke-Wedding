    ...
    (Lilac = {
      ...
      preloader: function () {
        var t = setInterval(function () {
          /loaded|complete/.test(document.readyState) &&
            (clearInterval(t), e("#color-picker").val("#374e7a") && e("#preloader").fadeOut(500));
        }, 10);
      },
      navigation: function () {
        e(".nav li a").on("click", function (t) {
          ...
          "#" === a.attr("href").charAt(0)
            ? (t.preventDefault(),
              "#home" !== a.attr("href") && (i = e(a.attr("href")).offset().top - 65),
              e("html, body")
                .stop()
                .animate(
                  {
        ...
        (t = t),
          e("#wrapper > section").waypoint({
            handler: function (t) {
              var a = e(this),
                i = a[0].element.id;
              "up" === t && (i = a[0].element.previousElementSibling.id),
                e(".nav a").removeClass("active"),
                e('nav a[href="#' + i + '"]').addClass("active");
            },
            offset: "50%",
          }),
      ...
      createMobileMenu: function (t) {
        ...
        (i = e.browser.mobile ? "touchstart" : "click"),
          ...
          t <= 975 &&
            ...
            (a = e(".nav-mobile")),
            e("#nav-mobile-btn").bind(i, function (t) {
              t.stopPropagation(),
                t.preventDefault(),
                setTimeout(function () {
                  s.addClass("open"), a.addClass("open"), a.getNiceScroll().show();
                }, 25),
                e(document).bind(i, function (t) {
                  e(t.target).hasClass("nav-mobile") ||
                    e(t.target).parents(".nav-mobile").length ||
                    (s.removeClass("open"), a.removeClass("open"), e(document).unbind(i));
                }),
            ...
            (n.mobMenuFlag = !0),
            e(".nav-mobile li a").bind("click", function (t) {
              var n = e(this),
                o = 0;
              "#home" !== n.attr("href") && (o = e(n.attr("href")).offset().top - 65),
                e("html, body")
                  .stop()
                  .animate(
                    {
      ...
      googleMap: function () {
        ...
        var t,
          ...
          l = 0;
        for (
          (/^\d|\.|-$/.test(o.map_initial_latitude) && /^\d|\.|-$/.test(map_initial_longitude)) ||
            ((o.map_initial_latitude = map_markers[0].latitude), (o.map_initial_longitude = map_markers[0].longitude)),
            a = new google.maps.LatLng(o.map_initial_latitude, o.map_initial_longitude),
            this.use_default_map_style ||
              (r = [
                {
                  stylers: [
                    {
            ...
            (n = new google.maps.Map(document.getElementById(o.map_canvas_id), i)).mapTypes.set("map_style", t),
      ...
      //         if (!(i < n)) return !1;
      //         e(".tweet").eq(i).html(e(this).html()), i += 1
      ...
      //                 o = 0,
      //                 r = 0;
      //             for ("" !== i && i.hasOwnProperty("data") && (o = i.data.length); r < o;) s < n && (e(".instagram").eq(s).html('<img src="' + i.data[r].images.standard_resolution.url + '" alt="" /><span><a href="' + i.data[r].images.standard_resolution.url + '" data-gal="prettyPhoto[gallery]" title="' + i.data[r].caption.text + '"><i class="fa fa-link"></i></a><a href="' + i.data[r].link + '" target="_blank" title="View on Instagram"><i class="fa fa-external-link"></i></a></span>'), s += 1), r += 1;
      //             t.createPrettyPhoto()
      //         },
      //         error: function() {
      ...
      createOwlSliders: function () {
        e(".timeline-gallery").length &&
          ...
          e(".bridesmaids-groomsmen-slider").length &&
            e(".bridesmaids-groomsmen-slider").owlCarousel({
              itemsCustom: [
                [0, 1],
                [590, 2],
                [751, 2],
      ...
      countdown: function (t, a) {
        ...
        o.html(
          '<div class="days"><span>' +
            n.c_days +
            '</span><div></div></div><div class="hours"><span>' +
            n.c_hours +
            '</span><div></div></div><div class="minutes"><span>' +
            n.c_minutes +
            '</span><div></div></div><div class="seconds"><span>' +
            n.c_seconds +
            "</span><div></div></div>"
        ),
      ...
      resizeVideos: function () {
        ...
        t.each(function () {
          var t = e(this);
          t.attr("data-aspectRatio", t.height() / t.width())
            .removeAttr("height")
            .removeAttr("width");
        }),
          e(window)
            ...
            c.each(function () {
              ...
              "hidden" === t.attr("type")
                ? t.hasClass("subject")
                  ...
                  ? (u += "&fromemail=" + o(t.val()))
                  : (t.hasClass("emailTo") || t.hasClass("emailto")) && (u += "&emailto=" + o(t.val()))
                : t.hasClass("required") && "" === t.val()
                ? (t.addClass("invalid"), (h = !0))
                : "email" === t.attr("type") && "" !== t.val() && !1 === m.test(t.val())
                ? (t.addClass("invalid"), (h = !0))
                : "recaptcha_response_field" !== t.attr("id") &&
                  (t.removeClass("invalid"),
                  t.hasClass("subject")
                    ? ((u += "&subject=" + o(t.val())), (u += "&subject_label=" + t.attr("name")))
                    : t.hasClass("fromName") || t.hasClass("fromname")
                    ? ((u += "&fromname=" + o(t.val())), (u += "&fromname_label=" + t.attr("name")))
                    : t.hasClass("fromEmail") || t.hasClass("fromemail")
                    ? ((u += "&fromemail=" + o(t.val())), (u += "&fromemail_label=" + t.attr("name")))
                    : t.hasClass("radio-lilac")
                    ? ((u += "&field" + d + "_label=" + t.data("value")),
                      (u += "&field" + d + "_value=" + e(".active", t).data("value")),
                      (d += 1))
                    : ((u += "&field" + d + "_label=" + t.attr("name")), (u += "&field" + d + "_value=" + o(t.val())), (d += 1)));
            }),
            (u += "&len=" + d),
            (i = function () {
              r.width(r.width()),
      ...
      buttons: function () {
        ...
        e(".bridesmaids-groomsmen-buttons .btn").click(function (a) {
          ...
          var i = e(this),
            n = i.data("slider");
          i.hasClass("active") ||
            (e(".bridesmaids-groomsmen-slider").addClass("hide").css({
              opacity: 0,
            }),
            t
              ? ((t = !1), e("#" + n).removeClass("hide"))
              : e("#" + n)
                  .removeClass("hide")
                  .animate(
                    {
            ...
            e(".bridesmaids-groomsmen-buttons .btn").removeClass("active"),
            i.addClass("active");
        }),
          ...
          e(".add_button").click(function (t) {
            ...
            (a =
              ...
              '" value="' +
              r +
              '" /><span class="input-group-addon"><i class="fa fa-trash"></i></span></div>'),
              e("#" + n)
                .data("count", s)
                .append(a),
              o.val(""),
          ...
          e(".add_list").on("click", ".input-group-addon", function () {
            const maxGuests = readCookie("maxGuests");

            e(this).closest(".input-group").remove();

            const numOfAddGuest = $("#guest_list")[0].childElementCount;
            if (numOfAddGuest + 1 < maxGuests) {
              $("#add_guest").show();
            }
          });
      },
      animateElems: function () {
        ...
        var t = function () {
          e("[data-animation-delay]").each(function () {
            ...
            t.addClass("animate-" + s),
              a + i >= t.offset().top &&
                (isNaN(n) || 0 === n
                  ? t.removeClass("animate-" + s).addClass("animation-" + s)
                  : setTimeout(function () {
                      t.removeClass("animate-me").addClass("animation-" + s);
                    }, n));
          });
        };
        e(window).innerWidth() >= 751 &&
